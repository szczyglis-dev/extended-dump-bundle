PHP: **7.2.5+, 8.0+**, current release: **1.0.20** build 2022-04-29
...
**- 1.0.20** - User debug moved to bottom in debugger window, data collapsed at start, added version info, added section items counters and more (2022-04-29)
