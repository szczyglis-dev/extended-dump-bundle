PHP: **7.2.5+, 8.0+**, current release: **1.0.19** build 2022-04-29
...
**- 1.0.19** - User debug moved to bottom in debugger window, data collapsed at start, added version info, added section items counters (2022-04-29)
