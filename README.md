PHP: **7.2.5+, 8.0+**, current release: **1.1.4** build 2022-04-29
...
**- 1.1.4** - Added doctrine entities and repositories debugger, added parameters dumper, increased configuration options and added some other small improvements (2022-04-29)
